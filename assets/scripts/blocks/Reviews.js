...
class $c142f6e5c1efc0c8$var$Reviews {
    constructor(root){
        this.root = root;
        ...
        setTimeout(()=>{
            this.slider = new (0, $hvi9e.default)(this.root.querySelector('.js-reviews-slider'), {
                swiperOptions: {
                    slidesPerView: 1,
                    autoplay: false,
                    loop: false,
...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    reviews_blocks.forEach((reviews_block)=>{
        new $c142f6e5c1efc0c8$var$Reviews(reviews_block);
    });
});
