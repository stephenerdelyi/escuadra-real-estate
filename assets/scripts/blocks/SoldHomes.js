...
})({"bNPeO":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "4356808c4d46fe48";
"use strict";
...
},{}],"fRE0m":[function(require,module,exports,__globalThis) {
...
class SoldHomes {
    constructor(root){
        ...
        setTimeout(()=>{
            this.card_slider = new (0, _sliderDefault.default)(this.root.querySelector('.js-sold-homes-card-slider'), {
                swiperOptions: {
                    slidesPerView: 1,
                    loop: false
                },
            ...
            this.image_slider = new (0, _sliderDefault.default)(this.root.querySelector('.js-sold-homes-image-slider'), {
                swiperOptions: {
                    effect: "fade",
                    slidesPerView: 1,
                    autoplay: false,
            ...
            if (this.card_slider.swiper) this.card_slider.swiper.on('slideChange', ()=>{
...
},{"../../utils/utils":"3PNrL","../../utils/dom":"iauJ2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["bNPeO","fRE0m"], "fRE0m", "parcelRequire4037", {})

//# sourceMappingURL=SoldHomes.js.map
