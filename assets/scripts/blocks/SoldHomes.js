...
class $389faa2a5d9841ca$var$SoldHomes {
    constructor(root){
        this.root = root;
        ...
        setTimeout(()=>{
            this.card_slider = new (0, $hvi9e.default)(this.root.querySelector('.js-sold-homes-card-slider'), {
                swiperOptions: {
                    slidesPerView: 1,
                    loop: false
                },
            ...
            this.image_slider = new (0, $hvi9e.default)(this.root.querySelector('.js-sold-homes-image-slider'), {
                swiperOptions: {
                    effect: "fade",
                    slidesPerView: 1,
                    autoplay: false,
...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    sold_homes_blocks.forEach((sold_homes_block)=>{
        new $389faa2a5d9841ca$var$SoldHomes(sold_homes_block);
    });
});
