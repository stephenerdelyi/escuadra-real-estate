...
})({"i70Ei":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "08acb2bb999b0bf4";
"use strict";
...
},{}],"7zCqR":[function(require,module,exports,__globalThis) {
...
class TabbedContent {
    constructor(root){
        ...
        this.buttons.forEach((button, index)=>{
            button.addEventListener('click', (event)=>{
                ...
                if (this.image_slider) this.image_slider.swiper.slideTo(index);
            });
        });
        setTimeout(()=>{
            this.image_slider = new (0, _sliderDefault.default)(this.root.querySelector('.js-tabbed-content-image-slider'), {
                swiperOptions: {
                    slidesPerView: 1,
                    loop: false
                },
            ...
            this.text_slider = new (0, _sliderDefault.default)(this.root.querySelector('.js-tabbed-content-text-slider'), {
                swiperOptions: {
                    effect: "fade",
                    slidesPerView: 1,
                    autoplay: false,
    ...
    setActiveButton(index) {
        this.buttons.forEach((button, btn_index)=>{
            ...
            if (btn_index == index) button.classList.add('--active');
        });
    }
}
...
},{"../../utils/utils":"3PNrL","../../utils/dom":"iauJ2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["i70Ei","7zCqR"], "7zCqR", "parcelRequire4037", {})
