...
class $d43c8fbe40663bde$var$TabbedContent {
    constructor(root){
        this.root = root;
        ...
        setTimeout(()=>{
            this.image_slider = new (0, $hvi9e.default)(this.root.querySelector('.js-tabbed-content-image-slider'), {
                swiperOptions: {
                    slidesPerView: 1,
                    loop: false
                },
            ...
            this.text_slider = new (0, $hvi9e.default)(this.root.querySelector('.js-tabbed-content-text-slider'), {
                swiperOptions: {
                    effect: "fade",
                    slidesPerView: 1,
                    autoplay: false,
...
document.addEventListener('DOMContentLoaded', ()=>{
    ...
    tabbed_content_blocks.forEach((tabbed_content_block)=>{
        new $d43c8fbe40663bde$var$TabbedContent(tabbed_content_block);
    });
});
