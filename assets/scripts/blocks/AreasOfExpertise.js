...
})({"dNVy8":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "247b5acb94bb04f8";
"use strict";
...
},{}],"iJkrl":[function(require,module,exports,__globalThis) {
...
class AreasOfExpertise {
    constructor(root){
        ...
        this.surrounding_areas.addEventListener('mouseover', (event)=>{
            if (this.surrounding_text) this.surrounding_text.classList.add('--active');
        });
        this.surrounding_areas.addEventListener('mouseout', (event)=>{
            if (this.surrounding_text) this.surrounding_text.classList.remove('--active');
        });
        this.areas_container.addEventListener('mouseout', (event)=>{
            this.areas.forEach((inner_area)=>{
                inner_area.classList.remove('--inactive');
            });
            if (this.primary_slider?.swiper) this.primary_slider.swiper.slideTo(0);
            if (this.secondary_slider?.swiper) this.secondary_slider.swiper.slideTo(0);
        });
        this.areas.forEach((area)=>{
            area.addEventListener('mouseover', (event)=>{
                this.areas.forEach((inner_area)=>{
                    if (inner_area == event.target) inner_area.classList.remove('--inactive');
                    else inner_area.classList.add('--inactive');
                });
                if (this.primary_slider?.swiper) this.primary_slider.swiper.slideTo(event.target.dataset.slideId);
                if (this.secondary_slider?.swiper) this.secondary_slider.swiper.slideTo(event.target.dataset.slideId);
            });
        });
        setTimeout(()=>{
            this.primary_slider = new (0, _sliderDefault.default)(this.root.querySelector('.js-areas-of-expertise-primary-slider'), {
                swiperOptions: {
                    effect: "fade",
                    slidesPerView: 1,
                    autoplay: false,
            ...
            this.secondary_slider = new (0, _sliderDefault.default)(this.root.querySelector('.js-areas-of-expertise-secondary-slider'), {
                swiperOptions: {
                    effect: "fade",
                    slidesPerView: 1,
                    autoplay: false,
...
},{"../helpers/Slider":"4f8Pk","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4f8Pk":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class Slider {
    constructor(root, options = {}){
        ...
        if (this.slides.length <= 1) {
            if (this.next_btn) this.next_btn.classList.add('--hidden');
            if (this.prev_btn) this.prev_btn.classList.add('--hidden');
            return;
        }
    ...
    updatePagination() {
        ...
        if (this.pagination_label) this.pagination_label.innerHTML = slide_num + ' of ' + total_slides;
        if (this.swiperOptions.loop == false) {
            if (slide_num == 1) this.prev_btn.classList.add('--disabled');
            else this.prev_btn.classList.remove('--disabled');
            if (slide_num == total_slides) this.next_btn.classList.add('--disabled');
            else this.next_btn.classList.remove('--disabled');
        }
    }
}
...
},{}],"iauJ2":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"../../utils/utils":"3PNrL","../../utils/dom":"iauJ2","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dNVy8","iJkrl"], "iJkrl", "parcelRequire4037", {})

//# sourceMappingURL=AreasOfExpertise.js.map
